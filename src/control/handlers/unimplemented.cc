...
grpc::Status Unimplemented(std::string_view method, std::string_view wave) {
    ...
    osw::log::Debug("control",
                    ...
                    static_cast<int>(wave.size()),   wave.data());
...
grpc::Status ControlServiceSkeleton::Hangup(
    grpc::ServerContext*,
...
grpc::Status ControlServiceSkeleton::Hold(
    grpc::ServerContext*,
...
grpc::Status ControlServiceSkeleton::Unhold(
    grpc::ServerContext*,
